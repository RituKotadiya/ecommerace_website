import React, { useContext } from 'react';       // ✅ Only this is needed
...
function Home() {
      ...
      const products = [
            ...
            { id: 3, image: model, name: "Fashion", description: "Description for product 3" },
            { id: 4, image: tabel, name: "Dining-Set", description: "Description for product 4" },
                              ...
                              products1.map((item) => {
                                    return (
                                          <div class="card" style={{ width: "18rem" }}>
                                                ...
                                                <button className="btn" style={{ backgroundColor: 'rgba(209, 125, 35, 0.7)', color: 'white' }} onClick={() => handleAddToCart(item)}>ADD TO CARD</button>
                                          </div>
                                    )
                              })
                        }
                        ...
                        <div class="card mb-3" style={{ maxwidth: "540px", width: "700px" }} >
                              <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                          ...
                                          <button class="btn btn-primary" style={{ backgroundColor: 'rgba(209, 125, 35, 0.7)', color: 'white' }}>Shop Now</button>
                                    </div>
                              </div>
                        </div>
                  </div>
